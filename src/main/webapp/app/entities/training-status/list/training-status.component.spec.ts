...
describe('TrainingStatus Management Component', () => {
  let comp: TrainingStatusComponent;
  let fixture: ComponentFixture<TrainingStatusComponent>;
  let service: TrainingStatusService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'training-status', component: TrainingStatusComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(TrainingStatusComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.trainingStatuses?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
