...
@Component({
  selector: 'sportechapp-course-status',
...
export class CourseStatusComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.courseStatusService
      ...
      .subscribe({
        next: (res: HttpResponse<ICourseStatus[]>) => {
  ...
  trackId(_index: number, item: ICourseStatus): number {
    return item.id!;
  }

  delete(courseStatus: ICourseStatus): void {
    const modalRef = this.modalService.open(CourseStatusDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.courseStatus = courseStatus;
  ...
  protected onSuccess(data: ICourseStatus[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
