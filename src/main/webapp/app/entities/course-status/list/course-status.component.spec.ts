...
describe('CourseStatus Management Component', () => {
  let comp: CourseStatusComponent;
  let fixture: ComponentFixture<CourseStatusComponent>;
  let service: CourseStatusService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'course-status', component: CourseStatusComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(CourseStatusComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.courseStatuses?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
