...
export class CourseService {
  ...
  protected convertDateFromClient(course: ICourse): ICourse {
    return Object.assign({}, course, {
      startDate: course.startDate?.isValid() ? course.startDate.format(DATE_FORMAT) : undefined,
      endDate: course.endDate?.isValid() ? course.endDate.format(DATE_FORMAT) : undefined,
    });
  }
