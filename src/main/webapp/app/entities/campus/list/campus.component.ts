...
export class CampusComponent implements OnInit {
  ...
  trackId(_index: number, item: ICampus): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: ICampus[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
