...
describe('Campus Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'campus', component: CampusComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.campuses?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
