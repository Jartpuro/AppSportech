...
describe('CourseModule Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'course-module', component: CourseModuleComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.courseModules?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
