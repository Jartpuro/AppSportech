...
@Component({
  selector: 'sportechapp-schedule-version',
  templateUrl: './schedule-version.component.html',
})
export class ScheduleVersionComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.scheduleVersionService
      ...
      .subscribe({
        next: (res: HttpResponse<IScheduleVersion[]>) => {
  ...
  trackId(_index: number, item: IScheduleVersion): number {
    return item.id!;
  }

  delete(scheduleVersion: IScheduleVersion): void {
  ...
  protected onSuccess(data: IScheduleVersion[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
