...
export class YearComponent implements OnInit {
  ...
  trackId(_index: number, item: IYear): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IYear[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
