...
describe('TrainingProgram Management Component', () => {
  let comp: TrainingProgramComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'training-program', component: TrainingProgramComponent }]),
      ...
      .overrideTemplate(TrainingProgramComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.trainingPrograms?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
