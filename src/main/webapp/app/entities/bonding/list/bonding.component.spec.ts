...
describe('Bonding Management Component', () => {
  let comp: BondingComponent;
  let fixture: ComponentFixture<BondingComponent>;
  let service: BondingService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'bonding', component: BondingComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(BondingComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.bondings?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
