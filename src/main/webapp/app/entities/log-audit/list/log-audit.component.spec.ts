...
describe('LogAudit Management Component', () => {
  let comp: LogAuditComponent;
  let fixture: ComponentFixture<LogAuditComponent>;
  let service: LogAuditService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'log-audit', component: LogAuditComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(LogAuditComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.logAudits?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
