...
/**
 * REST controller for managing {@link co.edu.sena.domain.Module}.
 */
@RestController
@RequestMapping("/api")
public class ModuleResource {
     ...
     */
    @GetMapping("/modules")
    public ResponseEntity<List<ModuleDTO>> getAllModules(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
