...
public class DayResource {
    ...
    public ResponseEntity<DayDTO> partialUpdateDay(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, dayDTO.getId().toString())
        );
    }
     ...
     */
    @GetMapping("/days")
    public ResponseEntity<List<DayDTO>> getAllDays(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
