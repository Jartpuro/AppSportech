...
class AreaResourceIT {
    ...
    public static Area createEntity(EntityManager em) {
        Area area = new Area().areaName(DEFAULT_AREA_NAME).urlLogo(DEFAULT_URL_LOGO).areaState(DEFAULT_AREA_STATE);
        return area;
    }
    ...
    public static Area createUpdatedEntity(EntityManager em) {
        Area area = new Area().areaName(UPDATED_AREA_NAME).urlLogo(UPDATED_URL_LOGO).areaState(UPDATED_AREA_STATE);
        return area;
    }
    ...
    void createArea() throws Exception {
        ...
        assertThat(testArea.getAreaState()).isEqualTo(DEFAULT_AREA_STATE);
    }
    ...
    void putNewArea() throws Exception {
        ...
        assertThat(testArea.getAreaState()).isEqualTo(UPDATED_AREA_STATE);
    }
    ...
    void partialUpdateAreaWithPatch() throws Exception {
        ...
        partialUpdatedArea.areaName(UPDATED_AREA_NAME).urlLogo(UPDATED_URL_LOGO);
