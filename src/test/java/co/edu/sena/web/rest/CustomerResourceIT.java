...
class CustomerResourceIT {
    ...
    void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getFisrtLastName()).isEqualTo(DEFAULT_FISRT_LAST_NAME);
        assertThat(testCustomer.getSecondLastName()).isEqualTo(DEFAULT_SECOND_LAST_NAME);
    }
    ...
    void putNewCustomer() throws Exception {
        ...
        assertThat(testCustomer.getFisrtLastName()).isEqualTo(UPDATED_FISRT_LAST_NAME);
        assertThat(testCustomer.getSecondLastName()).isEqualTo(UPDATED_SECOND_LAST_NAME);
    }
    ...
    void partialUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.documentNumber(UPDATED_DOCUMENT_NUMBER).secondLastName(UPDATED_SECOND_LAST_NAME);
